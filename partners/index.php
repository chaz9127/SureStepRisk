                        ...
                        <div class="box-1 bg-box-5 maxheight1">
                            <div class="inside clearfix">
                                <div class="w1">
                                    <div class="box-6">
                                        <!-- date for event -->
                                        <span class="text-4">February</span>
                                        <span class="text-5">12</span>
                                    </div>
                                    <!-- Title for event -->
                                    <div class="color-2"><strong>IBM THINK Conference</strong></div>
                                </div>
                                <!-- body for event -->
                                <div class="w1">
                                    Join SureStep at the annual IBM THINK Conference as we showcase our offerings. Meet our GRC and RegTech teammembers while learning about IBM's solutions.
                                    <a href="https://www.ibm.com/events/think/" class="btn">More Info Here</a>
                                </div>
                            </div>
                        </div>
                    </li>
